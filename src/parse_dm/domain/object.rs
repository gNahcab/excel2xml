use crate::parse_dm::domain::object::ValueObject::{BooleanValue, DateValue, GeonameValue, IntValue, ResLinkValue, ListValue, TextValue, TimeValue, UriValue, Representation, ColorValue, DecimalValue};
